...
INSERT INTO `mannschaft` (`mannschaft_id`, `mannschaft_name`, `logopfad`, `sportart_id`)
VALUES (1, 'Borussia Dortmund', '/resources/imgs/logos/Fußball/bvb.png', 1),
...
INSERT INTO `mitarbeiter` (`benutzername`, `passwort`, `vorname`, `nachname`)
VALUES ('earner', '123', 'Wucas', 'Lerner'),
...
INSERT INTO `quote` (`spiel_id`, `quotenart`, `quote`)
VALUES (1, 'HEIM', 1),
       (1, 'AUSWAERTS', 10.1),
       (1, 'UNENTSCHIEDEN', 4.3),
       (2, 'HEIM', 2),
...
INSERT INTO `spiel` (`spiel_id`, `sportart_id`, `mannschaft_heim`, `mannschaft_auswaerts`, `datum`, `ergebnis`)
VALUES (1, 1, 1, 2, '2019-06-08 15:00:00', NULL),
...
INSERT INTO `sportart` (`sportart_id`, `sportart_name`)
VALUES (1, 'Fußball'),
       (2, 'Basketball'),
       (3, 'Eishockey');

DROP TABLE IF EXISTS `wettschein`;
CREATE TABLE `wettschein`
(
...
TRUNCATE TABLE `wettschein`;
INSERT INTO `wettschein` (`wettschein_id`, `einsatz`)
VALUES (1, 1.00),
       (2, 2.01),
       (3, 3.01),
       (4, 4.01),
...
INSERT INTO `wette` (`wette_id`, `spiel_id`, `wettschein_id`, `gesetzte_wette`)
VALUES (1, 2, 1, 'HEIM'),
       (2, 5, 1, 'UNENTSCHIEDEN'),
       (3, 4, 2, 'AUSWAERTS'),
       (4, 6, 3, 'HEIM'),
...
ALTER TABLE `mannschaft`
    MODIFY `mannschaft_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 23;
...
ALTER TABLE `sportart`
    MODIFY `sportart_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 4;

ALTER TABLE `wette`
    MODIFY `wette_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 51;
COMMIT;